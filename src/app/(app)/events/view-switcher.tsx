...
import { BUILT_IN_EVENT_VIEWS } from "@/lib/event-view-helpers";
import type { SavedEventView } from "@/lib/event-view-types";
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div className="flex min-w-0 flex-1 items-center gap-1 overflow-x-auto rounded-lg border border-border bg-surface p-1">
        {BUILT_IN_EVENT_VIEWS.map((v) => pill(v.key, v.label))}
