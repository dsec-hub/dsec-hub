...
const TARGETS: TargetRole[] = [
  { name: "Admin", description: "Full access to every module plus user, role, and invite management.", modules: ALL, writeModules: ALL, isSystem: true, viewConfig: vc("/dashboard", "all-tasks", "my_work", "upcoming_events", "tasks_due_soon", "action_items", "committee_health", "membership", "finance_summary", "expense_breakdown", "event_budgets", "sponsor_pipeline") },
  { name: "Exec", description: "Full access to every operational module (no admin panel).", modules: APP, writeModules: APP, isSystem: false, viewConfig: vc("/dashboard", "my-work", "my_work", "upcoming_events", "tasks_due_soon", "action_items", "committee_health", "membership", "finance_summary", "sponsor_pipeline") },
  { name: "Secretary", description: "Runs meetings + records: meetings, documents, action items.", modules: ["meetings", "documents", "people", "tasks"], writeModules: ["meetings", "documents"], isSystem: false, viewConfig: vc("/meetings", "my-work", "my_work", "upcoming_events", "action_items") },
  { name: "External Affairs Lead", description: "Owns sponsorships + outreach to other clubs/partnerships.", modules: ["sponsors", "partners", "people", "tasks", "events", "meetings"], writeModules: ["sponsors", "partners", "tasks", "meetings"], isSystem: false, viewConfig: vc("/sponsors", "by-committee", "my_work", "sponsor_pipeline", "upcoming_events", "action_items") },
  { name: "External Affairs Member", description: "Works the sponsor + partner pipeline.", modules: ["sponsors", "partners", "people", "tasks", "meetings"], writeModules: ["sponsors", "partners"], isSystem: false, viewConfig: vc("/sponsors", "my-work", "my_work", "sponsor_pipeline") },
  { name: "Marketing Lead", description: "Leads marketing content/promo per event.", modules: ["events", "tasks", "people", "documents", "meetings"], writeModules: ["tasks", "meetings"], isSystem: false, viewConfig: vc("/tasks", "by-committee", "my_work", "upcoming_events", "tasks_due_soon", "action_items") },
  { name: "Marketing Member", description: "Marketing content/promo; edits own tasks.", modules: ["events", "tasks", "people", "meetings"], writeModules: [], isSystem: false, viewConfig: vc("/tasks", "my-work", "my_work", "upcoming_events") },
  { name: "Design Lead", description: "Leads graphics/post design for events (currently unstaffed).", modules: ["events", "tasks", "people", "documents", "meetings"], writeModules: ["tasks", "documents", "meetings"], isSystem: false, viewConfig: vc("/tasks", "by-committee", "my_work", "upcoming_events", "action_items") },
  { name: "Design Member", description: "Designs graphics/posts for events; edits own tasks (currently unstaffed).", modules: ["events", "tasks", "people", "meetings"], writeModules: [], isSystem: false, viewConfig: vc("/tasks", "my-work", "my_work", "upcoming_events") },
  { name: "Development Lead", description: "Leads technical projects + event tech.", modules: ["projects", "events", "tasks", "people", "documents", "meetings"], writeModules: ["projects", "events", "tasks", "meetings"], isSystem: false, viewConfig: vc("/projects", "by-committee", "my_work", "upcoming_events", "action_items") },
  { name: "Development Member", description: "Builds projects + event tech; edits own tasks.", modules: ["projects", "events", "tasks", "people", "meetings"], writeModules: ["projects"], isSystem: false, viewConfig: vc("/projects", "my-work", "my_work") },
  { name: "General Member", description: "General committee member: own tasks + read events/people/meetings.", modules: ["tasks", "people", "events", "meetings"], writeModules: [], isSystem: false, viewConfig: vc("/tasks", "my-work", "my_work") },
  ...
  { name: "Auditor", description: "Read-only across every operational module.", modules: APP, writeModules: [], isSystem: false, viewConfig: vc("/dashboard", "all-tasks", "upcoming_events", "membership", "finance_summary", "sponsor_pipeline", "committee_health") },
